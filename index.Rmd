...
abstract: |
  `r paste(readLines("text/front-and-back-matter/_abstract.Rmd"), collapse = '\n  ')`
#acknowledgements:
#dedication: 
...
url-in-bibliography: false #set to true if you want URL's to be shown in the bibliography
...
```{r introduction, child = 'text/_00-introduction.Rmd'}
```
